...
public class Profile
  ...
  public MatchInfo getMatchInfo(String pattens[], String className) {
    ...
    for (int i = 0; i < pattens.length; i++) {
      ...
      if (-1 == subIndex)
        return match;
      if (0 != subIndex && reserveMatched)
        match.reserved.append(sub.substring(0, subIndex)).append(".");
  ...
  public int compareTo(Object object) {
    ...
    return (new CompareToBuilder()).append(myClass.packageName, packageName).toComparison();
  }

  public String toString() {
    return (new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)).append("name", name).append("packageName", packageName).append("ctlPrefix", ctlPrefix).append("ctlPostfix", ctlPostfix).append("pagePrefix", pagePrefix).append("pagePostfix", pagePostfix).append("defaultMethod", defaultMethod).append("simpleURIStyle", simpleURIStyle).toString();
  }
  ...
  public void setCtlPrefix(String ctlPrefix) {
    ...
    ctlPrefixSegs = StringUtils.split(ctlPrefix, '*');
  }
  ...
  public void setPackageName(String packageName) {
    ...
    packageSegs = StringUtils.split(packageName, '*');
  }
